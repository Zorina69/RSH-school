...
class SchoolSystem{
    ...
    public: 
        ...
        void displayStudentList(){
            ...
            string file4 = "HtmlCssJavascrpit_students_file.csv";
            ofstream writeToStudentList("Students_list.csv");
            if(!writeToStudentList){
                cout<<"Erorr: Cannot open file"<<endl;
            }
            const string colectionFiles[]={file1,file2,file3,file4};
           
            for(const auto& file: colectionFiles){
        ...
        void displayInformation() {
            ...
            if (!infoFile) {
                cout << "Error: Cannot open Information.txt file." << endl;
                return;
            }
            string line;
