...
void ReportInformation() {
    ...
    if (choice == "c++") {
        fstream cpp_students_file;
        cpp_students_file.open("cpp_students_file.csv", ios::in);
        ...
        fstream python_students_file;
        python_students_file.open("python_students_file.csv", ios::in);
        ...
        html_students_file.open("HtmlCssJavascrpit_students_file.csv", ios::in);

        if (!html_students_file) {
            cout << "HtmlCssJavascrpit_students_file.csv is not found!" << endl;
            return;
        }
        ...
        fstream java_students_file;
        java_students_file.open("java_students_file.csv", ios::in);
